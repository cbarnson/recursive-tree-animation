...
\begin{DoxyCode}{0}
\DoxyCodeLine{23                              \{}
\DoxyCodeLine{24   width = w;}
\DoxyCodeLine{25   height = h;}
\DoxyCodeLine{26 }
\DoxyCodeLine{27   al\_init();}
\DoxyCodeLine{28 }
\DoxyCodeLine{29   \textcolor{comment}{// if the display cannot be initialized, we should throw an}}
\DoxyCodeLine{30   \textcolor{comment}{// exception. We will deal with exceptons later in the course, so}}
\DoxyCodeLine{31   \textcolor{comment}{// for now, we simply exit}}
\DoxyCodeLine{32   \textcolor{keywordflow}{if} ((display = al\_create\_display(width, height)) == NULL) \{}
\DoxyCodeLine{33     std::cerr << \textcolor{stringliteral}{"Cannot initialize the display"} << std::endl;}
\DoxyCodeLine{34     exit(1);  \textcolor{comment}{// non-zero argument means "trouble"}}
\DoxyCodeLine{35   \}}
\DoxyCodeLine{36 }
\DoxyCodeLine{37   al\_init\_primitives\_addon();}
\DoxyCodeLine{38 \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{44                   \{}
\DoxyCodeLine{45   al\_destroy\_display(display);}
\DoxyCodeLine{46 \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{61 \{ \textcolor{keywordflow}{return} display; \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{54 \{ \textcolor{keywordflow}{return} height; \};}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{48 \{ \textcolor{keywordflow}{return} width; \};}
