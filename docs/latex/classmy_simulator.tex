...
\begin{DoxyCode}{0}
\DoxyCodeLine{62 \{ toDraw.push\_back(p); \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{69 \{ toUpdate.push\_back(p); \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{76                               \{}
\DoxyCodeLine{77     \textcolor{keywordflow}{for} (std::list<std::shared\_ptr<Updateable>>::iterator it = toUpdate.begin();}
\DoxyCodeLine{78          it != toUpdate.end(); ++it)}
\DoxyCodeLine{79       (*it)->update(dt);}
\DoxyCodeLine{80   \}}
